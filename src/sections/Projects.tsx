        ...
        <section id="work" className="bg-bg px-6 py-24 text-ink sm:px-12">
            ...
            <div className="grid grid-cols-1 gap-8 border-t border-line pt-12 lg:grid-cols-2">
                ...
                <p className="max-w-md self-end text-sm leading-relaxed text-ink/60">
                    Here are some of the projects I've worked on, ranging from enterprise platforms
                    to SaaS products and landing pages. Each one reflects my focus on functionality,
                    ...
                    >
                        ...
                        >
                            <div>
                                ...
                                <h3 className="display mt-6 text-3xl sm:text-4xl">{project.title}</h3>
            ...
            <div className="mt-16 flex flex-col items-center gap-4 border-t border-line pt-12">
                ...
                <div className="flex gap-5">
                    <a href="https://github.com/GustinRhezaRNA" aria-label="GitHub Profile" className="text-ink/70 transition hover:text-ink">
                    ...
                    <a href="https://gitlab.com/rezarna4" aria-label="GitLab Profile" className="text-ink/70 transition hover:text-ink">
                        <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
